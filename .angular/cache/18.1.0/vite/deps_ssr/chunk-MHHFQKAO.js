...
var _ActionsSubject = class _ActionsSubject extends import_rxjs2.BehaviorSubject {
  constructor() {
    super({
      type: INIT
    });
...
var _ReducerManager = class _ReducerManager extends import_rxjs2.BehaviorSubject {
  get currentReducers() {
...
var _ScannedActionsSubject = class _ScannedActionsSubject extends import_rxjs2.Subject {
  ngOnDestroy() {
    this.complete();
  }
};
...
var _State = class _State extends import_rxjs2.BehaviorSubject {
...
var _Store = class _Store extends import_rxjs2.Observable {
...
@angular/core/fesm2022/rxjs-interop.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-MHHFQKAO.js.map
